...
let stats: Stats = {
  STR: 0, CON: 0, SIZ: 0, INT: 0, POW: 0, DEX: 0, CHA: 0
};
let background = '';
let startingMoney = 0;
...
const roll3d6 = () => {
  const rolls = Array(3).fill(0).map(() => Math.floor(Math.random() * 6) + 1);
  return {
  ...
  <div class="space-y-4">
    ...
    <div class="space-y-4 p-6">
      ...
      <div class="grid grid-cols-2 gap-4">
        <div class="space-y-2">
          <label class="text-sm font-medium">Character Name</label>
          <input
            bind:value={name}
        ...
        <div class="space-y-2">
          <label class="text-sm font-medium">Generation Rules</label>
          <select 
      ...
      {#if derivationNotes.length > 0}
        <div class="mt-4">
          <h3 class="font-bold mb-2">Derivation Notes</h3>
